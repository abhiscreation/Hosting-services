      ...
      <div className="grok-auth-form-wrap">
        <div className={`grok-auth-form ${status === "submitting" ? "grok-auth--work" : "grok-auth--idle"}`} ref={formRef}>
          ...
          <div className="grok-auth-head">
            <h2 className="grok-auth-title">Create Your Account</h2>
          ...
          <form className="grok-auth-body" onSubmit={handleSubmit}>
            <div className="grok-auth-field">
              ...
              <input
                ...
                className={`grok-auth-input ${errors.username ? "is-error" : ""}`}
                placeholder="Enter your username"
                aria-label="Username"
              />
              {errors.username && <span className="grok-auth-error">{errors.username}</span>}
            </div>
            <div className="grok-auth-field">
            ...
            <div className="grok-auth-field">
              ...
              <input
                ...
                onChange={handleChange}
                className={`grok-auth-input ${errors.confirmPassword ? "is-error" : ""}`}
                placeholder="Confirm your password"
                aria-label="Confirm Password"
              />
              {errors.confirmPassword && <span className="grok-auth-error">{errors.confirmPassword}</span>}
            </div>
            <button
              type="submit"
